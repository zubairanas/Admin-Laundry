...
import {getAllReferal , DeleteReferal } from '../../redux/thunk/referalSlice'
function Categories() {
  ...
  const getCategories = async (
   ...
   // );
    ...
    const response = await dispatch(getAllReferal(data)).unwrap()
      setLoading(false);
  ...
  const deleteCategory = async () => {
    ...
    const resp = await dispatch(DeleteReferal(data)).unwrap()
  ...
  const columns = [
    ...
    },
    {
      ...
      },
      {
        ...
        dataIndex: "limitReferalTimes",
        key: "limitReferalTimes",
      },
      {
        title: "Discount",
        dataIndex: "discount",
    ...
    <Layout className="configuration">
      <div className="boxDetails">
        <Row style={{ padding: "10px 20px" }}>
          ...
          >
            <h1 className="pageName">REFERAL MANAGEMENT</h1>
          </Col>
          <Col
            xs={24}
            md={12}
