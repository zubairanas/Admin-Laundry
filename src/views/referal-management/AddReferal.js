...
import { CreateReferal } from '../../redux/thunk/referalSlice'
...
function AddCategory() {
  ...
  const onFinish =  async (values) => {
   ...
   const {title,discount,limitReferalTimes } = values
    ...
    const Udata = {
        ...
        limitReferalTimes : Number(limitReferalTimes)
    }
    ...
    const newCategory = await dispatch(CreateReferal(data)).unwrap()
            ...
            >
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input Referal Name!",
                  },
                ]}
              >
                <Input
                  size="large"
                  placeholder="Enter Name of Referal"
                  style={{
                    borderRadius: "5px",
                    background: "white",
                    fontSize: "14px",
              ...
              >
                <Input
                  size="large"
                  placeholder="Enter Referal Discount"
                  type="number"
                  style={{
                    borderRadius: "5px",
                    background: "white",
              ...
              <Form.Item
                label="Referal Limit"
                name="limitReferalTimes"
                rules={[
                  {
                    required: true,
                    message: "Please input Referal limit!",
                  },
                ]}
              >
                <Input
                  size="large"
                  placeholder="Enter Referal Limit"
                  type="number"
                  style={{
                    borderRadius: "5px",
                    background: "white",
